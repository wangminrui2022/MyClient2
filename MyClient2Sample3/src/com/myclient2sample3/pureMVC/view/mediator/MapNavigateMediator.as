package com.myclient2sample3.pureMVC.view.mediator
{
	...
	import com.myclient2sample3.pureMVC.view.ui.MapNavigate;
	...
	public class MapNavigateMediator extends Mediator
	{
		...
		public static const MNM_SET_MAP_NAVIGATE_COMPLETE:String="mnm_set_map_navigate_complete";
		...
		private function onComplete(e:Event):void
		{
			...
			this.sendNotification(MNM_SET_MAP_NAVIGATE_COMPLETE);
		}
		/**
		 * 设置地图导航信息
		 */
		private function setMapNavigateInfo():void
		{
			...
			mapNavigate.navigate.mX=roleP.role2.x;
			mapNavigate.navigate.mY=roleP.role2.y;			
		}
		/**
		 * 移动地图导航
		 */
		...
		{	
			mapNavigate.title=getInfo();	
			mapNavigate.navigate.setFrame(roleP.role2.x,roleP.role2.y);				
		}
		/**
		 * 
		 * @return 
